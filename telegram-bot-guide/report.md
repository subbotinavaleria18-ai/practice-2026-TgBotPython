...
| Название бота | /start | /tutorial | /news | /gallery | Обратная связь |
|---------------|--------|-----------|-------|----------|----------------|
| RPG World Bot | ✅ | ✅ | ❌ | ✅ | ❌ |
| Quest Adventure | ✅ | ❌ | ✅ | ❌ | ✅ |
| SimCity Helper | ✅ | ✅ | ✅ | ❌ | ❌ |
...
Рисунок 2.1.1. — UML-диаграмма компонентов Telegram-бота
...
<img width="1150" height="911" alt="2026-05-16_19-16-55" src="https://github.com/user-attachments/assets/f2d2e55d-2585-4a37-b4c6-ed5264205401" />

Рисунок 3.1.1 — Cкриншот диалога с BotFather (команда /newbot и полученный токен)
...
<img width="1121" height="840" alt="2026-05-16_19-33-22" src="https://github.com/user-attachments/assets/8c0c90d8-77c2-4b50-b0f2-2365724f254c" />

Рисунок 6.2. — Скриншот финального интерфейса бота.
